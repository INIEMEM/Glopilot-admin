...
const HouseNoticeDetails = () => {
  ...
  const fetchReservationNotice = async () => {
    try {
      ...
      const response = await Axios({
        method: 'get',
        url: `${baseUrl}vendor-hotel/admin-reservation-notice?reservationId=${houseNotice}`,
        headers: {
  ...
  const handleRowClick = (admins) => {
    navigate(`/dashboard/house/notice/send`, {
      state: { reservationId:houseNotice },
    });
  };
...
export default HouseNoticeDetails